...
const AccordionItem = ({ q, a }: { q: string, a: string }) => {
  ...
  return (
    <div className="border border-border/50 rounded-xl bg-card overflow-hidden transition-all duration-300">
      <button 
        onClick={() => setIsOpen(!isOpen)} 
        className="w-full text-left px-6 py-4 flex items-center justify-between font-semibold hover:bg-muted/30 transition-colors text-sm md:text-base"
      >
        {q}
        {isOpen ? <ChevronUp className="h-5 w-5 text-muted-foreground shrink-0 ml-4" /> : <ChevronDown className="h-5 w-5 text-muted-foreground shrink-0 ml-4" />}
      </button>
      <AnimatePresence>
        {isOpen && (
          <motion.div
          ...
          >
            <div className="px-6 pb-4 text-muted-foreground text-sm leading-relaxed border-t border-border/50 pt-3">
              {a}
            </div>
          </motion.div>
        )}
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden selection:bg-primary/30">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        {/* Glow Effects */}
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUp} custom={0} className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 text-xs text-muted-foreground font-medium">
        ...
        >
          <div className="relative w-full max-w-2xl lg:max-w-3xl aspect-square md:aspect-video lg:aspect-[4/3] rounded-3xl overflow-hidden border border-primary/20 shadow-[0_0_60px_rgba(0,181,204,0.2)] bg-black/40">
            <video 
              src="/hero-video.mp4" 
              autoPlay 
              loop 
      ...
      <section className="py-24 relative overflow-hidden bg-muted/20 border-y border-border/30 text-center px-4">
         <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          ...
          >
            ...
            <p className="text-xl md:text-2xl italic font-serif text-muted-foreground mb-8">
              "The Skills You Have Today May Not Be Enough Tomorrow"
            </p>
            <div className="w-16 h-0.5 bg-primary/50 mx-auto mb-8" />
            <p className="text-sm md:text-base text-muted-foreground mx-auto max-w-2xl leading-relaxed">
      ...
      <section className="py-24 container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
           ...
           className="relative h-[400px] flex items-center justify-center bg-card rounded-3xl border border-border/50 overflow-hidden"
        >
           {/* Abstract orange elliptical glowing rings */}
           <div className="absolute w-[80%] h-[40%] border-[2px] border-orange-500/30 rounded-[100%] rotate-45 animate-spin shadow-[0_0_30px_rgba(249,115,22,0.2)]" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
           <div className="absolute w-[85%] h-[45%] border-[1px] border-orange-400/20 rounded-[100%] rotate-12 animate-spin shadow-[0_0_50px_rgba(249,115,22,0.1)]" style={{ animationDuration: '20s' }} />
           <div className="absolute w-[70%] h-[35%] border-[3px] border-white/10 rounded-[100%] -rotate-12 animate-spin" style={{ animationDuration: '10s' }} />
           <div className="absolute w-[75%] h-[50%] border-[1px] border-orange-300/10 rounded-[100%] -rotate-45 animate-spin" style={{ animationDuration: '25s' }} />
        </motion.div>
          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Data-driven analysis based on millions of career transitions and real-time pulse skill needs.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">We identify the exact "delta" between where you are and where you want to be.</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Forget generic courses. Get curated resources tailored for your specific gap.</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <section className="py-24 bg-muted/10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-muted-foreground italic">*Three steps to complete clarity</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {phases.map((p, i) => (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="bg-card glass-card-hover border border-border/60 p-8 rounded-2xl flex flex-col relative overflow-hidden group"
              >
      ...
      <section className="py-24 container mx-auto px-6 border-b border-border/30">
         <div className="grid md:grid-cols-2 gap-8">
            ...
            >
               ...
               <p className="text-sm md:text-base leading-relaxed mb-8 relative z-10 italic text-muted-foreground">
               ...
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <p className="text-[11px] text-muted-foreground uppercase tracking-wider">Senior Software Developer</p>
                 </div>
               </div>
            </motion.div>
            ...
            >
               ...
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <p className="text-[11px] text-muted-foreground uppercase tracking-wider">Computer Science Graduate</p>
                 </div>
               </div>
            </motion.div>
         </div>
      ...
      <section className="py-24 relative text-center px-4">
        ...
        <div className="container mx-auto max-w-3xl relative z-10">
          ...
          <p className="text-muted-foreground text-sm md:text-base mx-auto max-w-lg mb-10">

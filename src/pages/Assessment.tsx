...
const questions: Question[] = [
  ...
  { id: 1, section: "YOUR CURRENT DIRECTION", type: "select", question: "What do you want most right now?", options: [
    { title: "Clarity on what suits me" }, { title: "Faster growth in my career" }, { title: "A meaningful path aligned with my values" },
  ]},
  { id: 2, section: "YOUR CURRENT DIRECTION", type: "select", question: "Which statement feels closest to you?", options: [
    { title: "I want to discover my strengths" }, { title: "I want to level up strategically" }, { title: "I want to design my life's work" },
  ]},
  { id: 3, section: "YOUR CURRENT DIRECTION", type: "select", question: "What is your biggest career frustration today?", options: [
    { title: "Too many options, no clear direction" }, { title: "I feel stuck or underutilized" }, { title: "My work lacks meaning" },
  ]},
  { id: 4, section: "YOUR CURRENT DIRECTION", type: "select", question: "Your time horizon for change:", options: [
    { title: "3–6 months" }, { title: "1–2 years" }, { title: "5+ years" },
  ]},
  { id: 5, section: "YOUR CURRENT DIRECTION", type: "select", question: "When making career decisions, you usually:", options: [
    { title: "Need structured guidance" }, { title: "Compare options and outcomes" }, { title: "Follow what feels aligned" },
  ]},
  { id: 6, section: "YOUR CURRENT DIRECTION", type: "select", question: "Which outcome motivates you most?", options: [
    { title: "Building strong skills" }, { title: "Advancing position and income" }, { title: "Creating meaningful impact" },
  ]},

  // SECTION 2 — WHAT ENERGISES YOU? (RIASEC)
  { id: 7, section: "WHAT ENERGISES YOU?", type: "swipe", question: "I enjoy solving real-world practical problems.", options: [
    { title: "Yes" }, { title: "Sometimes" }, { title: "No" },
  ]},
  { id: 8, section: "WHAT ENERGISES YOU?", type: "swipe", question: "I enjoy analysing data, systems, or complex ideas.", options: [
    { title: "Yes" }, { title: "Sometimes" }, { title: "No" },
  ]},
  { id: 9, section: "WHAT ENERGISES YOU?", type: "swipe", question: "I enjoy creative expression (design, writing, storytelling).", options: [
    { title: "Yes" }, { title: "Sometimes" }, { title: "No" },
  ]},
  { id: 10, section: "WHAT ENERGISES YOU?", type: "swipe", question: "I enjoy helping or guiding people.", options: [
    { title: "Yes" }, { title: "Sometimes" }, { title: "No" },
  ]},
  { id: 11, section: "WHAT ENERGISES YOU?", type: "swipe", question: "I enjoy leading initiatives or influencing outcomes.", options: [
    { title: "Yes" }, { title: "Sometimes" }, { title: "No" },
  ]},
  { id: 12, section: "WHAT ENERGISES YOU?", type: "swipe", question: "I enjoy organising systems, plans, or details.", options: [
    { title: "Yes" }, { title: "Sometimes" }, { title: "No" },
  ]},

  // SECTION 3 — WHAT MATTERS MOST TO YOU?
  { id: 13, section: "WHAT MATTERS MOST?", type: "select", question: "Which matters more?", options: [
    { title: "Freedom & autonomy" }, { title: "Stability & security" },
  ]},
  { id: 14, section: "WHAT MATTERS MOST?", type: "select", question: "Which matters more?", options: [
    { title: "High earnings" }, { title: "Meaningful contribution" },
  ]},
  { id: 15, section: "WHAT MATTERS MOST?", type: "select", question: "Which environment suits you better?", options: [
    { title: "Structured and predictable" }, { title: "Flexible and evolving" },
  ]},
  { id: 16, section: "WHAT MATTERS MOST?", type: "select", question: "You prefer work that is:", options: [
    { title: "Deeply specialised" }, { title: "Varied and multidisciplinary" },
  ]},
  { id: 17, section: "WHAT MATTERS MOST?", type: "select", question: "Your ideal impact style:", options: [
    { title: "Behind the scenes" }, { title: "Visible leadership" }, { title: "Thought leadership" },
  ]},

  // SECTION 4 — HOW YOU WORK
  { id: 18, section: "HOW YOU WORK", type: "select", question: "A project lacks direction. You:", options: [
    { title: "Define structure and plan" }, { title: "Analyse before acting" }, { title: "Generate new ideas" }, { title: "Support the team" },
  ]},
  { id: 19, section: "HOW YOU WORK", type: "select", question: "You receive minimal instructions. You feel:", options: [
    { title: "Energised" }, { title: "Neutral" }, { title: "Uncomfortable" },
  ]},
  { id: 20, section: "HOW YOU WORK", type: "select", question: "When facing uncertainty, you usually:", options: [
    { title: "Act quickly" }, { title: "Evaluate carefully" }, { title: "Wait for clarity" },
  ]},
  { id: 21, section: "HOW YOU WORK", type: "select", question: "You feel most proud when:", options: [
  ...
  { id: 22, section: "PERSONALITY SNAPSHOT", type: "swipe", question: "I take initiative easily.", options: [
    { title: "Low" }, { title: "Medium" }, { title: "High" },
  ]},
  { id: 23, section: "PERSONALITY SNAPSHOT", type: "swipe", question: "I follow through reliably.", options: [
    { title: "Low" }, { title: "Medium" }, { title: "High" },
  ]},
  { id: 24, section: "PERSONALITY SNAPSHOT", type: "swipe", question: "I enjoy collaborating with others.", options: [
    { title: "Low" }, { title: "Medium" }, { title: "High" },
  ]},
  { id: 25, section: "PERSONALITY SNAPSHOT", type: "swipe", question: "I stay calm under pressure.", options: [
    { title: "Low" }, { title: "Medium" }, { title: "High" },
  ]},
  { id: 26, section: "PERSONALITY SNAPSHOT", type: "swipe", question: "I adapt quickly to change.", options: [
    { title: "Low" }, { title: "Medium" }, { title: "High" },
  ]},

  // SECTION 6 — READINESS & ROADMAP INTENT
  { id: 27, section: "READINESS & INTENT", type: "slider", question: "How ready are you to take action on a career plan?", sliderMin: 0, sliderMax: 10 },
  { id: 28, section: "READINESS & INTENT", type: "select", question: "What support would help you most?", options: [
      ...
      <header className="border-b border-border/30 bg-background/80 backdrop-blur-xl">
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            <span className="hidden md:inline">{q.section}</span>
            <span className="border border-border rounded-full px-3 py-1 font-semibold">{current + 1} / {questions.length}</span>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="flex items-center gap-4 mt-12">
          ...
          <button onClick={next} disabled={!isAnswered}
            ...
            {current === questions.length - 1 ? "Finish" : "Continue"} <ArrowRight className="h-4 w-4" />
          </button>
        </div>
